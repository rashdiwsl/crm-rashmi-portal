            ...
            <tbody className="divide-y divide-gray-50">
              {leads.map(lead => (
                <tr key={lead.id} className="hover:bg-gray-50 transition">
                  <td className="px-5 py-4 font-medium text-gray-900">{lead.lead_name}</td>
                  <td className="px-5 py-4 text-gray-500">{lead.company_name}</td>
                  <td className="px-5 py-4"><LeadStatusBadge status={lead.status} /></td>
                  <td className="px-5 py-4 text-gray-500">{lead.lead_source}</td>
                  <td className="px-5 py-4 text-gray-500">{lead.assigned_to}</td>
                  <td className="px-5 py-4 text-gray-700 font-medium">LKR {lead.deal_value?.toLocaleString()}</td>
